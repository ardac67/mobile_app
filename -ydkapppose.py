    ...
    def main(self):
        while self.running:
            try:
                ...
                top5_indices = np.argsort(probabilities)[-5:][::-1]  # Top 5 predictions
                ...
                # Build the payload with top 5 predictions
                payload = {
                    "sourceIP": source_ip,
                    ...
                    "metrics": {
                        ...
                        "totalPackets": int(total_packets),
                        "totalBytes": int(total_bytes),
                        "averagePacketSize": float(average_packet_size),
